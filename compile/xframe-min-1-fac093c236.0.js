...
String.prototype.formateString = function (n) {
  ...
  var i = function i(t, e) {
    ...
    if (void (this.length = 0) === t) return this;if ("string" == typeof t) {
      ...
      }(t), this.length = n.length, r = 0, i = this.length; r < i; r++) {
        this[r] = n[r];
      }
  ...
  xframe.extend({ each: function each(t) {
    ...
    } }, _defineProperty(_xframe$extend, "ajax", function ajax(e) {
  ...
  }), _defineProperty(_xframe$extend, "json2String", function json2String(t) {
    ...
    return eval(str);
      ...
      return !(null == t || "object" != (typeof t === "undefined" ? "undefined" : _typeof(t)) || !Object.prototype.toString.call(t));
  ...
  t.extend({}), t.extend(t, { $id: function $id(t) {
      return this.isString(t) ? document.getElementById(t) : t;
      ...
      var t = [].slice.call(arguments)[0].toString().split(","),
        ...
        var t;(t = n.$cengci(this)).length && t.each(function () {
          e.push(this);
        });
      }), e;
    } });
  ...
  o.extend({ add: function add(t) {
      ...
      }return e = e, "string" == typeof t && (t = $(t)), t.length ? Array.prototype.slice.call(t).each(function () {
        r(this.children);
      }) : r(t.children), $(n);
    } });
}(xframe), function (t) {
  var o;t.extend({}), t.extend(t, {}), t.Animate = (o = { timer: null, queen: [], run: function run() {
      ...
      return { linear: function linear(t, e, n, r) {
          ...
          var i = 1.70158,
              o = 0,
              a = n;return 0 == t ? e : 1 == (t /= r) ? e + n : (o || (o = .3 * r), i = a < Math.abs(n) ? (a = n, o / 4) : o / (2 * Math.PI) * Math.asin(n / a), -a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * r - i) * (2 * Math.PI) / o) + e);
        }, easeOutElastic: function easeOutElastic(t, e, n, r) {
          var i = 1.70158,
              o = 0,
              a = n;return 0 == t ? e : 1 == (t /= r) ? e + n : (o || (o = .3 * r), i = a < Math.abs(n) ? (a = n, o / 4) : o / (2 * Math.PI) * Math.asin(n / a), a * Math.pow(2, -10 * t) * Math.sin((t * r - i) * (2 * Math.PI) / o) + n + e);
        }, easeInOutElastic: function easeInOutElastic(t, e, n, r) {
          var i = 1.70158,
              o = 0,
              a = n;return 0 == t ? e : 2 == (t /= r / 2) ? e + n : (o || (o = r * (.3 * 1.5)), i = a < Math.abs(n) ? (a = n, o / 4) : o / (2 * Math.PI) * Math.asin(n / a), t < 1 ? a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * r - i) * (2 * Math.PI) / o) * -.5 + e : a * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * r - i) * (2 * Math.PI) / o) * .5 + n + e);
